...
<body>
  ...
  <div class="container mt-3">
    ...
    <div class="alert alert-success" role="alert">
      ...
      <hr>
      <p >Whenever you need to, make sure to Logout. <a href="./logout.php">Logout</a></p>
    </div>
    <?php
        ...
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Entschuldigung!!!  </strong> You are not varified!!!!
            <div class="container d-flex">
            <input type="text" class="form-control" name="iotp" aria-describedby="emailHelp">
            <button type="submit" class="btn btn-secondary">Submit OTP</button>
            </div>
        </div>
        </form>
    	';
